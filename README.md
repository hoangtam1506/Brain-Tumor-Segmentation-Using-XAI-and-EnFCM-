...
**2/ DATASET**
Brain Tumor MRI Dataset (Kaggle): Tập dữ liệu được cung cấp bởi Masoud Nickparvar trên nền tảng Kaggle, phục vụ nghiên cứu về nhận diện và phân loại khối u não từ ảnh MRI.
